...
public class MAKEADMIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ASSIGN AS ADMIN");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(block, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(77, 77, 77))
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MAKEADMIN().setVisible(false);
            }
        });
    }
    ...
    // End of variables declaration//GEN-END:variables
        ...
        try {
            ...
            String query = "update `users` set type='admin' WHERE username ='"+this.username.getText()+"' and `status`= 'able'";
            ...
            JOptionPane.showMessageDialog(this,""+usernameinput+" is now an Admin Successfully!.");  
