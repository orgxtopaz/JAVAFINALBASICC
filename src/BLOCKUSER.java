...
public class BLOCKUSER extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BLOCKUSER().setVisible(false);
            }
        });
    }
    ...
    // End of variables declaration//GEN-END:variables
      ...
      public void blockuser() {
        ...
        try {
            ...
            String query = "update `users` set status='disable' WHERE username ='"+this.username.getText()+"' and `type`= 'user'";
            ...
            JOptionPane.showMessageDialog(this,""+this.username.getText()+" is Blocked Successfully!.");  
